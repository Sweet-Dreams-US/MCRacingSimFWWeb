...
//
// These canonical options are the single source of truth for the waiver /
...
// CHECK constraints must match this list — see the migration that adds
// 'Radio'). Never store a free-text paragraph.
